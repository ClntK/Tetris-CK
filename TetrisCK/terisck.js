...
function drawNextTetromino(image) {
    console.log(
        image.width, image.height, minicanvas.width, minicanvas.height
    )
    minictx.drawImage(image, 0, 0, image.width * 2, image.height * 2,
        (minicanvas.height - image.height) / 2.2, (minicanvas.width - image.width) / 2.2, minicanvas.width, minicanvas.height);
}
...
// test for overlap of tets at top of gamebox as indicator for lost game
